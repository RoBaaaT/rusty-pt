...
fn write_output(file: std::fs::File, width: u32, height: u32) -> std::io::Result<()> {
    ...
    let samples = 10;
    let mat1 = Lambertian::new(Vec3::new(0.2, 0.3, 1.0));
    let mat2 = Lambertian::new(Vec3::new(0.3, 0.4, 0.1));
    let sphere1 = Sphere::new(Vec3::new(0.0, 0.0, -1.0), 0.5, &mat1);
    let sphere2 = Sphere::new(Vec3::new(0.0, -100.5, -1.0), 100.0, &mat2);
